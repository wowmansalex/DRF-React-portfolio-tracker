...
export const TRANSACTION_ASSET = 'api/crypto/transaction/asset/';
export const TRANSACTION_DETAIL = 'api/crypto/transaction/detail/';
export const LOG_DATA = '/api/crypto/log_data/';
